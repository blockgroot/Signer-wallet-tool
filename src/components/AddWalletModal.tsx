  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50">
      <div className="w-full max-w-md rounded-lg bg-white p-6 shadow-xl">
        <div className="mb-4">
          <h2 className="text-2xl font-bold text-black">Add Multisig Wallet</h2>
          <p className="mt-2 text-sm text-black">
            Add a new multisig wallet to the registry.
          </p>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                placeholder="0x..."
                required
                className="mt-1 block w-full rounded-md border border-gray-300 bg-white px-3 py-2 font-mono text-sm text-black shadow-sm focus:border-indigo-500 focus:outline-none focus:ring-indigo-500"
                autoFocus
              />
